...
import { ArrowLeft, Save, Upload, Plus, Trash2, FileText, Calendar, Tag, User } from 'lucide-react';
...
export default function NewBlogPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const result = await addBlog(processedData);
            if (result.success) {
                router.push('/dashboard');
            } else {
                ...
                <div className="flex items-center justify-between max-w-5xl mx-auto w-full">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-zinc-500 text-sm">Share your insights and design philosphy with the world.</p>
                        </div>
                    </div>
                </div>
            </header>
