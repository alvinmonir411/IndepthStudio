...
import { ArrowLeft, Save, Upload, Plus, Trash2, User, Linkedin, Mail } from 'lucide-react';
...
export default function NewTeamMemberPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const result = await addTeamMember(processedData);
            if (result.success) {
                router.push('/dashboard');
            } else {
                ...
                <div className="flex items-center justify-between max-w-5xl mx-auto w-full">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-zinc-500 text-sm">Welcome a new creative to the Indepth Studio roster.</p>
                        </div>
                    </div>
                </div>
            </header>
