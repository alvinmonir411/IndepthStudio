...
import { ArrowLeft, Save, Upload, Plus, Trash2, Zap, Heart, Award } from 'lucide-react';
...
export default function NewServicePage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const result = await addService(processedData);
            if (result.success) {
                router.push('/dashboard');
            } else {
                ...
                <div className="flex items-center justify-between max-w-5xl mx-auto w-full">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-zinc-500 text-sm">Define a new area of expertise for Indepth Studio.</p>
                        </div>
                    </div>
                </div>
            </header>
