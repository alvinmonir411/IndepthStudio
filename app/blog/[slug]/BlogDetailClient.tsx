...
import { ArrowLeft, Clock, Share2, Facebook, Twitter, Linkedin, Check } from 'lucide-react';
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="font-medium text-stone-900">{post.author || 'Alvin Monir'}</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4">
                    ...
                    <div className="lg:col-span-8">
                        <div className="prose prose-stone prose-xl max-w-none">
                            ...
                            <div className="text-stone-800 font-light leading-loose space-y-8">
                                ...
                                ) : Array.isArray(post.fullContent) ? (
                        ...
                        {relatedPosts.length > 0 && (
                            <div className="flex flex-col gap-8">
                                ...
                                {relatedPosts.map(relPost => (
                                    <Link key={relPost._id} href={`/blog/${relPost.slug}`} className="group block">
