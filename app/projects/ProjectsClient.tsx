            ...
            <Link href={`/projects/${project._id}`} className="group block relative">
                <div className="relative aspect-[4/5] overflow-hidden rounded-[3rem] bg-stone-100 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] group-hover:shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] transition-all duration-700">
                    ...
                    <div className="absolute inset-x-6 bottom-6 z-20 text-white">
                        <div className="p-8 rounded-[2.5rem] bg-white/10 backdrop-blur-2xl border border-white/20 transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-700 ease-[0.22,1,0.36,1]">
                            ...
                            <p className="text-sm text-white/70 font-light leading-relaxed line-clamp-2">
